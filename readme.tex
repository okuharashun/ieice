...
C分冊の場合は欧文キャプションは不要です
（図\ref{fig:2}，表~\ref{table:4}参照）．
D分冊の場合は欧文キャプションは任意です．
...
\fbox{\box0}
\end{center}
\caption{図キャプションの例（A, B, D分冊）}
\label{fig:1}
\ecaption{An example of caption (A, B, D).}
\end{figure}
...
\caption{その他のマクロ（A, B, D分冊）}
\ecaption{Miscellaneous macros (A, B, D).}
\label{table:3}
\begin{center}
\begin{tabular}{c|c}
\Hline
